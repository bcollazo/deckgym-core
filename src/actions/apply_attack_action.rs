...
fn ominous_claw_attack(acting_player: usize, fixed_damage: u32) -> (Probabilities, Mutations) {
...
fn darkness_claw_attack(acting_player: usize, fixed_damage: u32) -> (Probabilities, Mutations) {
