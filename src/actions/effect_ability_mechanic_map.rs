...
pub static EFFECT_ABILITY_MECHANIC_MAP: LazyLock<HashMap<&'static str, AbilityMechanic>> =
    LazyLock::new(|| {
        ...
        map.insert(
            ...
            AbilityMechanic::BlockSupportCards,
        );
        ...
        map.insert(
            ...
            AbilityMechanic::BenchSafeguard,
        );
        map.insert(
        ...
        map.insert(
            ...
            AbilityMechanic::MoveEnergyFromBenchedTypedToActiveTyped {
        ...
        map.insert(
            ...
            AbilityMechanic::EndTurnHealSelf { amount: 20 },
        );
        map.insert(
        ...
        map.insert(
            ...
            AbilityMechanic::MultiTypeDamageBoost {
                energy_types: vec![EnergyType::Psychic, EnergyType::Metal],
                amount: 30,
            },
        );
        ...
        map.insert(
            ...
            AbilityMechanic::GrassEnergyDoubling,
        );
        ...
        map.insert(
            ...
            AbilityMechanic::CounterattackOnDamage { amount: 20 },
        );
        ...
        map.insert(
            ...
            AbilityMechanic::HealOneOfYourPokemon { amount: 30 },
        );
        ...
        map.insert(
            ...
            AbilityMechanic::OnEvolveDraw { amount: 2 },
        );
        ...
        map.insert(
            ...
            AbilityMechanic::AttachEnergyFromDiscardToSelfAndSelfDamage {
                energy_type: EnergyType::Fire,
                damage: 20,
            },
        );
        ...
        map.insert(
            ...
            AbilityMechanic::HealActivePokemon { amount: 20 },
        );
        ...
        map.insert(
            "Once during your turn, you may switch out your opponent's Active Pokémon to the Bench.\u{00a0}(Your opponent chooses the new Active Pokémon.)",
            AbilityMechanic::SwitchOutOpponentActive,
        );
        map.insert(
        ...
        map.insert(
            ...
            AbilityMechanic::AttachEnergyFromZoneToSelfEndTurn {
                energy_type: EnergyType::Psychic,
            },
        );
        ...
        map.insert(
            ...
            AbilityMechanic::SafeguardFromEx,
        );
        ...
        map.insert(
            ...
            AbilityMechanic::MorePoisonDamage { amount: 10 },
        );
        map.insert(
