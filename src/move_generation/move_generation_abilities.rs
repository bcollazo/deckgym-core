...
fn can_use_ability(state: &State, (in_play_index, card): (usize, &PlayedCard)) -> bool {
    ...
    match ability {
        ...
        AbilityId::A1067CloysterShellArmor => false,
        ...
        AbilityId::A2032PiloswineThickFat => false,
        AbilityId::A2033MamoswineThickFat => false,
        AbilityId::A2110DarkraiExNightmareAura => false,
        AbilityId::A2114BastiodonGuardedGrill => false,
